  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6 h-full">
      <div className="flex items-start justify-between mb-6">
        ...
        <a
          href="/admin/review"
          className="text-[10px] uppercase tracking-[0.15em] text-[#6b6b8a] hover:text-[#059669] transition-colors"
        >
          View All →
        </a>
      </div>
        ...
        <div className="flex flex-col gap-4">
          {recent.map((r) => {
            ...
            return (
              <div
                key={r._id}
                className="p-4 rounded-xl border border-gray-100 bg-gray-50 hover:border-gray-200 transition-colors"
              >
                    ...
                    <div className="flex gap-0.5 mb-2">
                      {[1, 2, 3, 4, 5].map((s) => (
                        <svg
                          ...
                          height={10}
                          viewBox="0 0 24 24"
                          fill={s <= (r.rating || 0) ? "#059669" : "none"}
                          stroke={s <= (r.rating || 0) ? "#059669" : "#3a3a52"}
                          strokeWidth="1.5"
                        >
